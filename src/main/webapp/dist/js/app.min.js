...
$.AdminLTE.pushMenu = function (toggleBtn) {
 ...
 // var screenSizes = this.options.screenSizes;
  ...
  $(toggleBtn).click(function (e) {
	...
	var sidebarObj = $(window.parent.document).find("#sidebarBox");
	var contentObj = $(window.parent.document).find("#contentBox");
	var sidebarFrameObj = $(window.parent.document).find("#sidebarFrame");
	var contentFrameObj = $(window.parent.document).find("#contentFrame");

    if ( sidebarObj.is(":visible") ) {
      sidebarObj.hide();
	  contentObj.width( $(window).width() );
	  contentFrameObj.width( $(window).width() );
    }
    else {
		sidebarObj.show();
		contentObj.width( $(window).width() - 230 );
		contentFrameObj.width( $(window).width() - 230 );
	}
